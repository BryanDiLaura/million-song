...
msd_subset_path='/home/brdi4739/Downloads/MillionSongSubset'
msd_subset_data_path=os.path.join(msd_subset_path,'data')
msd_subset_addf_path=os.path.join(msd_subset_path,'AdditionalFiles')
assert os.path.isdir(msd_subset_path),'wrong path' # sanity check
# path to the Million Song Dataset code
# CHANGE IT TO YOUR LOCAL CONFIGURATION
msd_code_path='/home/brdi4739/Downloads/MSongsDB'
...
for k in range(5):
   print (all_artist_names_sqlite[random.randrange(len(all_artist_names_sqlite))][0])
...
#    
#    artist_id.replace('b','').replace("'", "")
   
   files_per_artist[artist_id] += 1
   h5.close()
   
print("Counting songs per artist...")
...
# res = conn.execute(q)
# pop_artist_names = res.fetchall()
# conn.close()
# print ('SQL query:',q)
# print ('name(s) of the most popular artist:',pop_artist_names[:,0])
